...
def r13_fixes(token, stem_feats):
    ...
    # just added these new cases i got
    if token == '+ما' and stem_feats == {'pos': 'conj', 'prc3': '0', 'prc2': 'wa_conj', 'prc1': '0', 'prc0': 'na', 'enc0': '0', 'asp': 'na', 'vox': 'na', 'mod': 'na', 'gen': 'na', 'num': 'na', 'stt': 'na', 'cas': 'na', 'per': 'na', 'rat': 'n'}:
            stem_feats['enc0'] = 'mA_sub'

    if token == '+ما' and stem_feats == {'pos': 'conj', 'prc3': '0', 'prc2': 'fa_conj', 'prc1': '0', 'prc0': 'na', 'enc0': '0', 'asp': 'na', 'vox': 'na', 'mod': 'na', 'gen': 'm', 'num': 's', 'stt': 'na', 'cas': 'na', 'per': 'na', 'rat': 'i'}:
        stem_feats['enc0'] = 'mA_sub'
    
    if token == '+ما' and stem_feats == {'pos': 'conj', 'prc3': '0', 'prc2': 'fa_conj', 'prc1': '0', 'prc0': 'na', 'enc0': '0', 'asp': 'na', 'vox': 'na', 'mod': 'na', 'gen': 'na', 'num': 'na', 'stt': 'na', 'cas': 'na', 'per': 'na', 'rat': 'n'}:
        stem_feats['enc0'] = 'mA_sub'
    
    if token == 'بِ+' and stem_feats == {'pos': 'conj', 'prc3': '0', 'prc2': 'wa_conj', 'prc1': '0', 'prc0': 'na', 'enc0': '0', 'asp': 'na', 'vox': 'na', 'mod': 'na', 'gen': 'u', 'num': 'u', 'stt': 'na', 'cas': 'na', 'per': 'na', 'rat': 'y'}:
        stem_feats['prc1'] = 'bi_prep'
    ...
    for _, row in tokens_df.iterrows():
        ...
        if not is_clitic(token):
            ...
            if token == 'لِ+' and \
                ...
                or stem_feats == {'pos': 'conj', 'prc3': '0', 'prc2': 'wa_conj', 'prc1': '0', 'prc0': 'na', 'enc0': '0', 'asp': 'na', 'vox': 'na', 'mod': 'na', 'gen': 'na', 'num': 'na', 'stt': 'na', 'cas': 'na', 'per': 'na', 'rat': 'na'}
                or stem_feats == {'pos': 'conj', 'prc3': '0', 'prc2': 'fa_conj', 'prc1': '0', 'prc0': 'na', 'enc0': '0', 'asp': 'na', 'vox': 'na', 'mod': 'na', 'gen': 'na', 'num': 'na', 'stt': 'na', 'cas': 'na', 'per': 'na', 'rat': 'na'}
                or stem_feats == {'pos': 'conj_sub', 'prc3': '0', 'prc2': 'fa_conj', 'prc1': '0', 'prc0': 'na', 'enc0': '0', 'asp': 'na', 'vox': 'na', 'mod': 'na', 'gen': 'na', 'num': 'na', 'stt': 'na', 'cas': 'na', 'per': 'na', 'rat': 'na'}
                ):
